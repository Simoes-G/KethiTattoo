...
<body class="">
    ...
    <div class="registro d-flex justify-content-center align-items-center">
        <form action="" class="d-flex bg-primary flex-column div-registro" method="post">
            ...
            <input type="password" name="inputSenhaLogin" id="inputSenhaLogin">

            <button class="btn btn-outline-warning mt-5" id="botaoEntrar" name="botaoEntrar" type="button">Entrar</button>
            <span id="mensagem" hidden>erro</span>
    ...
    <script src="../js/dadosParaTratar/loginPHP/loginVerificacao.js"></script>
